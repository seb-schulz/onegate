...
export type Mutation = {
  ...
  updateMe: User;
  validateLogin?: Maybe<SuccessfulLogin>;
};
...
export type ValidateLoginMutation = { __typename?: 'Mutation', validateLogin?: { __typename?: 'SuccessfulLogin', redirectURL: string } | null };
